<template>
  <div>
    <div class="flex">
      ...
      <el-select v-model="search.value1" filterable clearable placeholder="请选择" size="small" style="width:86px;margin-right:14px;">
        <el-option
        ...
        <div class="headertitle">
      <el-select v-model="search.value2" filterable clearable placeholder="请选择" size="small" style="width:86px;margin-right:14px;">
        <el-option
          v-for="item in options"
          :key="item.value"
          :label="item.label"
        ...
        <div class="headertitle">
      <el-select v-model="search.value3" filterable clearable placeholder="请选择" size="small" style="width:86px;margin-right:14px;">
        <el-option
          v-for="item in options"
          :key="item.value"
          :label="item.label"
        ...
        <el-date-picker
          ...
          type="date"
          placeholder="选择日期"
          style="width: 86px; margin-right: 14px"
        >
        </el-date-picker>
        <div class="headertitle">
      <el-select v-model="search.value4" filterable clearable placeholder="请选择" size="small" style="width:86px;margin-right:14px;">
        <el-option
          v-for="item in options"
          :key="item.value"
          :label="item.label"
