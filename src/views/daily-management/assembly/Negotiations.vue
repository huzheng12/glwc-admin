<template>
  <div class="basicPage">
    ...
    >
      ...
      <el-table-column prop="executionStatus" label="核心议题">
      </el-table-column>
      <el-table-column prop="executionStatus" label="谈判人"> </el-table-column>
      <el-table-column prop="executionStatus" label="谈判对手">
      </el-table-column>
      <el-table-column prop="executionStatus" label="谈判文件">
      </el-table-column>
    </el-table>
  </div>
</template>
