  ...
  <div class="basicPage">
    <div class="titleName">
      ...
      <div class="titleName-li" @click="addPro">
        <i class="el-icon-edit-outline elRight"></i>下载
      </div>
    ...
    >
      ...
      <el-table-column prop="executionStatus" label="诉讼事项">
      </el-table-column>
      <el-table-column prop="executionStatus" label="诉讼阶段"> </el-table-column>
      <el-table-column prop="executionStatus" label="法院">
      </el-table-column>
      <el-table-column prop="executionStatus" label="服务商">
      </el-table-column>
      <el-table-column prop="executionStatus" label="授权合同编号">
      </el-table-column>
      <el-table-column prop="executionStatus" label="诉讼文件">
      </el-table-column>
    </el-table>
  </div>
</template>
